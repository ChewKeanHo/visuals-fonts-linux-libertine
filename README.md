# Linux Libertine Open Fonts | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Linux Libertine Open Fonts is a "designed from scratch" with completely
different typography direction than the Times or Arial for office used by
Philipp H. Poll from Linux Libertine (linuxlibertine.org). The goal is to create
an entirely free alternative to the standard fonts used in Microsoft ecosystems.
...
```
Title: Linux Libertine Open Fonts
Creators: Philipp H. Poll
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-linux-libertine
UUID: 3C071DA2-347F-4731-8B72-D9830C7E6967
License: SIL Open Font License (http://scripts.sil.org/OFL)
Repository Made On: 2026-03-08
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-fonts-linux-libertine
```
